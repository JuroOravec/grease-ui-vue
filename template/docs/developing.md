...
```shell
git clone https://github.com/<%= authorGithubUsername %>/<%= projectName %>.git
cd instance-manager
npm install
```
...
[contributing]: https://github.com/<%= authorGithubUsername %>/<%= projectName %>/blob/master/docs/CONTRIBUTING.md
